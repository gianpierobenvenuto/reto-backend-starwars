...
var require_data_stream = __commonJS({
  "node_modules/jws/lib/data-stream.js"(exports2, module2) {
    ...
    util4.inherits(DataStream, Stream);
...
var require_sign_stream = __commonJS({
  "node_modules/jws/lib/sign-stream.js"(exports2, module2) {
    ...
    util4.inherits(SignStream, Stream);
...
var require_verify_stream = __commonJS({
  "node_modules/jws/lib/verify-stream.js"(exports2, module2) {
    ...
    util4.inherits(VerifyStream, Stream);
...
// src/handlers/fusionados.ts
var fusionados_exports = {};
__export(fusionados_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(fusionados_exports);
...
async function getCachedFusionado(planet) {
  const command = new import_client_dynamodb.GetItemCommand({
    TableName: TABLE_NAME,
    Key: (0, import_util_dynamodb.marshall)({ id: planet })
  });
  ...
  if (item.source !== "manual" && cacheAge > 30 * 60 * 1e3) {
    return null;
  }
  return item;
}
async function cacheFusionado(planet, data) {
  const item = {
    id: planet,
    ...data,
    timestamp: Date.now()
...
var querySchema = z.object({
  planeta: z.string().min(1, 'El par\xE1metro "planeta" es obligatorio')
});
...
var handler = async (event) => {
  ...
  try {
    ...
    const weatherData = coords ? await getWeatherByLatLon(coords.lat, coords.lon) : await getWeatherByLatLon("0", "0");
    const fusionado = {
